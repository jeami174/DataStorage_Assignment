...
namespace Presentation_Console_MainApplication.Dialogs
{
    public static class CreateNewCustomerDialogs
    {
            ...
            ICustomerContactService customerContactService)
        {
            ...
            if (customerCreated)
            {
                // Hämta uppdaterad lista med kunder
                ...
                // Fråga om man vill koppla en kontaktperson
                ...
                if (attachChoice?.ToLower() == "y")
                {
                    ...
                    if (contactChoice == "1")
                    {
                        // Om kunden redan har kontaktpersoner (vanligtvis ej fallet för en ny kund)
                        if (newCustomer.CustomerContacts != null && newCustomer.CustomerContacts.Any())
                        {
                            ...
                            else
                            {
                                ...
                                // Här kan du eventuellt uppdatera kunden med den befintliga kontakten om det behövs.
                            }
                        }
                        else
                        {
